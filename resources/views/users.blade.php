                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card white-box p-0">
                            ...
                            <div class="row col-md-12 text-center mt-4">
                                <div class="col-md-4">
                                    <input class="search-input" type="text" placeholder=" User ID" name="" id="">
                                </div>
                                <div class="col-md-4">
                                    <input class="search-input" type="text" placeholder=" Username" name="" id="">
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="card-body">
                                <table id="usersTable" class="display" style="width:100%">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img class="user-avatar-table" src="images/avatar.png" alt="">
                                        ...
                                        <tr>
                                            ...
                                            <td>000-0000000</td>
                                            <td>DD/MM/YY</td>
                                            <td><select class="status-select" class="status-select" name="status" id="status">
                                                <option value="interviewed">Interviewed</option>
                                                <option value="interview">Interview</option>
                                                <option value="cancel">Cancel</option>
                                              </select></td>
